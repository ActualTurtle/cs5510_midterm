...
from .correlation.correlation_torch import CorrTorch
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        self.corr = CorrTorch(pad_size=md, kernel_size=ksz, max_displacement=md, stride1=st1, stride2=st2, corr_multiply=1)
