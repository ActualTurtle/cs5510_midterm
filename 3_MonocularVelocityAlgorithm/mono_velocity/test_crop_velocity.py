...
def return_arguments():
    ...
    # dir info
    parser.add_argument('--test_data', default='/home/kf7mxe/School/2023/Inteligence Robotics/my-inteligence-robotics-repo/mono_velocity/my_modified_mono_velocity/video/images_paths_annotations.txt')
    ...
    parser.add_argument('--output_directory', default='my-results')
    parser.add_argument('--res_file', default='test_crop_velocity.json')
    parser.add_argument('--basedir', default='/home/kf7mxe/School/2023/Inteligence Robotics/my-inteligence-robotics-repo/mono_velocity/my_modified_mono_velocity/video/')
    parser.add_argument('--md', default=4)
    parser.add_argument('--image_h', default=576)
    parser.add_argument('--image_w', default=1280)
    parser.add_argument('--cam_fx', default=1.24133712e+03)
    parser.add_argument('--cam_fy', default=1.26554056e+03)
    parser.add_argument('--cam_cx', default= 2.98293873e+02)
    parser.add_argument('--cam_cy', default=3.64212900e+02)
